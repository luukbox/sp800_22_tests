...
def psi_sq_mv1(m, n, padded_bits, name="psi_sq_mv1"):
    counts = [0 for i in range(2**m)]
    for i in tqdm(range(2**m), ascii=True, desc="Compute " + name):
...
def serial_test(bits, patternlen=None):
    ...
    # Step 2
    psi_sq_m = psi_sq_mv1(m, n, padded_bits, "psi_sq_m")
    psi_sq_mm1 = psi_sq_mv1(m-1, n, padded_bits, "psi_sq_mm1")
    psi_sq_mm2 = psi_sq_mv1(m-2, n, padded_bits, "psi_sq_mm2")
